...
public class Pixel : BaseParticleDef
{
	...
	{
		sprite.Draw(ZombieGame.spritesTex, loc, ScaleTools.ScaledRect(448, 896, 128, 128), new Color(1f, 1f, 1f, p.frame * 5f), 0f, new Vector2(64f, 64f) / 2f, p.size * ScrollMan.zoom * 2f, SpriteEffects.None, 1f);
	}
}
