...
public class Flame : BaseParticleDef
{
	...
	public override void Draw(Particle p, Vector2 loc, SpriteBatch sprite)
	{
		...
		sprite.Draw(ZombieGame.spritesTex, loc, ScaleTools.ScaledRect(1024, num * 64, 64, 64), new Color(1f, 1f, 1f, 0.7f), p.angle, new Vector2(32f, 32f) / 2f, new Vector2(1f, 0.9f) * ScrollMan.zoom * (1.2f - p.frame * 1.5f + p.size) * 2f, SpriteEffects.None, 1f);
	}
}
