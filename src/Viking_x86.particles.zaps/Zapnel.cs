...
public class Zapnel : BaseParticle
{
	...
	public override void Draw(SpriteBatch sprite, Particle p, Vector2 pLoc)
	{
		...
		sprite.Draw(Game1.vgame.spritesTex, pLoc, ScaleTools.ScaledRect(128 + Rand.GetRandomInt(0, 6) * 128, 0, 128, 64), new Color(1f, 1f, 1f, num), p.angle + VScroll.angle + 3.14f, new Vector2(0f, 32f) / 2f, 0.5f * VScroll.zoom * 2f, SpriteEffects.None, 1f);
	}
}
