...
public class ZapGlow : BaseParticle
{
	...
	{
		sprite.Draw(Game1.vgame.spritesTex, pLoc, ScaleTools.ScaledRect(128, 64, 128, 128), new Color(1f, 1f, 1f, p.frame * 5f), 0f, new Vector2(64f, 64f) / 2f, p.size * VScroll.zoom * 2f, SpriteEffects.None, 1f);
	}
}
